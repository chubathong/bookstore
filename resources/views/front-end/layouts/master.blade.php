...
<head>
    ...
    <title>@yield('title') - Phát Store - Website bán sách hàng đầu VN</title>
    ...
    <header id="header">
                        ...
                        <div class="row">
                            ...
                            <form class="col l5" action="{{ route('search') }}" method="GET" style="" id='form-submit'>
                                ...
                                <div class="search-wrapper card">
                                    <input id="search" name="txtSearch"
                                        placeholder="Nhập tên sách, tác giả, cty phát hành"
                            ...
                            <div class="col l5">
                                <ul class="hide-on-med-and-down">
                                    ...
                                    <li id="header-cart " class="col s5">
                                        <a data-reactroot="" rel="nofollow" href="{{ route('cart.index') }}"
        ...
        <div class="container">
            <div class="row" style="margin-bottom: 0">
                <div class=" main-nav-wrap col l3 " id="fixed-menu"
                    style="display: none;position: fixed;z-index: 99999999">
